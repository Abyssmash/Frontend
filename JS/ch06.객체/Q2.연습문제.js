...
for (let i = 0; i < numStr.length; i++) {           // let digit of numStr 문자열로 바꾸고 숫자로 바꿔서
    let num = parseInt(numStr[i]);                  // (digit)
    countArr[num]++;
}
...
let sample = `the grown-ups' response, this time, was to advise me to lay aside my drawings of 
            ...
            to geography, history, arithmetic, and grammar. That is why, at the, age of six, I gave up 
