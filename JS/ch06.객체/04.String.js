...
// 문자열 일부분 (substring)
let today = new Date().toISOString();       // 2024-07-19T02:13:17.765Z
console.log(today);
// 날짜 추출 - 2024 - 07 -19
console.log(today.substring(0, 10));    // 0은 포함, 10은 포함하지 않음 (0-9까지) (숫자의 의미: 글자 수)
// 시간 추출 - 02:12:21
console.log(today.substring(11, 19));   // 11에서 출발해서 8글자를 읽음 (11+8)
console.log(new Date().toLocaleString());       // 2024. 7. 19. 오전 11:21:13
...
console.log(sample.replace('o', 'O'));          // 1개만 바꿔짐 
